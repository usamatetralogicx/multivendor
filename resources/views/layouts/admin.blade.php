        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
                        ...
                        <li class="nav-main-item">
                         ...
                         <li class="nav-main-item">
                                    ...
                                    <ul class="nav-main-submenu">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{url('add_membership')}}">
                                                <span class="nav-main-link-name">Add Membership</span>
                                            </a>
                                        </li>
                                         <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{url('all_membership')}}">
                                                <span class="nav-main-link-name">All Membership</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <main id="main-container">
                ...
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <a class="link-fx" href="{{url('dashboard')}}">Membership</a>
                    </li>
                    <li class="breadcrumb-item">All membership</li>
                </ol>
            </nav>
                        </div>
                    </div>
